...
$(document).ready(function () {
    ...
    //定义常量
    var icon0 = new BMap.Icon("/Content/themes/images/location0.png", new BMap.Size(32, 32));
    var icon1 = new BMap.Icon("/Content/themes/images/location1.png", new BMap.Size(32, 32));
    var icon2 = new BMap.Icon("/Content/themes/images/location2.png", new BMap.Size(32, 32));
    var icon3 = new BMap.Icon("/Content/themes/images/location3.png", new BMap.Size(32, 32));
    var icon4 = new BMap.Icon("/Content/themes/images/location4.png", new BMap.Size(32, 32));
    var shadow = new BMap.Icon("/Content/themes/images/shadow.png", new BMap.Size(32, 32));
    ...
    contextMenu.addItem(new BMap.MenuItem('当前坐标', function (point) { prompt('经度,纬度：', point.lng + "," + point.lat); }, { iconUrl: '/Content/themes/images/point.png' }));
